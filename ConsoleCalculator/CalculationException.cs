...
namespace ConsoleCalculator
{
    public class CalculationException : Exception
    {
        private static readonly string DefaultMessage =
            "An error has occurred during calculation.  Ensure that the operator is supported and that the values are within the valid ranges for the requested operation.";
        ...
        /// <summary>
        /// Creates a new <see cref="CalculationException" /> with a predefined message and wrapped inner exception.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new <see cref="CalculationException" /> with a user-supplied message and wrapped inner exception.
        /// </summary>
